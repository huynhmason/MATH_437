...
By default, R sets the reference level to the first category in alpha-numeric order. For categories that use letters/words, the reference level is set to whatever category comes first in alphabetical order. For categories that use numbers, the reference leve is set to whatever number comes first in numerical order. 
